	...
	<main>
		<section>
			<div>
				...
				<form action="${pageContext.request.contextPath}/ServletAdmExcluirFuncionario" method="post">
					<label>Cpf:</label><br>
					<input type="text" id="cpf" name="cpf" required="required" placeholder="Login"><br><br>
