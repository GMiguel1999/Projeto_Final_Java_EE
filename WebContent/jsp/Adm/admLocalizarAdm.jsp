...
<body>
	...
	<main>
			...
			<div>
				<h2>Localizar Adm:</h2>
				<form action="${pageContext.request.contextPath}/ServletLocalizarAdm" method="post">
					<label>Login:</label><br>
					<input type="text" id="loginAdm" name="loginAdm" required="required" placeholder="Login"><br>
					<label>Senha:</label><br>
					<input type="password" id="senhaAdm" name="senhaAdm" required="required" placeholder="Senha"><br>
					...
					if (request.getSession().getAttribute("admEditado") != null) {
						...
						out.print(
								...
								"<form action=\"${pageContext.request.contextPath}/ServletAdmEditarAdm\" method=\"post\">" +
									...
									"<input type=\"text\" id=\"novoLogin\" placeholder=\"Novo login\" value=\"" + auxiliarAdm.getLogin() + "\"><br>" +
